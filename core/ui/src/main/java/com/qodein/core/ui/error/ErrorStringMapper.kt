...
fun OperationError.asUiText(): String =
    when (this) {
        ...
        PromocodeError.CreationFailure.CodeTooLong -> TODO()
        PromocodeError.CreationFailure.CodeTooShort -> TODO()
        PromocodeError.CreationFailure.DescriptionTooLong -> TODO()
        PromocodeError.CreationFailure.DiscountExceedsMinimumAmount -> TODO()
        PromocodeError.CreationFailure.EmptyCode -> TODO()
        PromocodeError.CreationFailure.InvalidDateRange -> TODO()
        PromocodeError.CreationFailure.InvalidFixedAmountDiscount -> TODO()
        PromocodeError.CreationFailure.InvalidMinimumAmount -> TODO()
        PromocodeError.CreationFailure.InvalidPercentageDiscount -> TODO()
        PromocodeError.CreationFailure.InvalidPromocodeId -> TODO()
        ServiceError.CreationFailure.EmptyName -> TODO()
        ServiceError.CreationFailure.InvalidServiceId -> TODO()
        ServiceError.CreationFailure.NameTooLong -> TODO()
        ServiceError.CreationFailure.NameTooShort -> TODO()
        ServiceError.SubmissionFailure.DuplicateService -> TODO()
        ServiceError.SubmissionFailure.InvalidData -> TODO()
        ServiceError.SubmissionFailure.NotAuthorized -> TODO()
        UserError.CreationFailure.BioTooLong -> TODO()
        UserError.CreationFailure.EmptyFirstName -> TODO()
        UserError.CreationFailure.FirstNameInvalidCharacters -> TODO()
        UserError.CreationFailure.FirstNameTooLong -> TODO()
        UserError.CreationFailure.FirstNameTooShort -> TODO()
        UserError.CreationFailure.InvalidEmail -> TODO()
        UserError.CreationFailure.InvalidPhotoUrl -> TODO()
        UserError.CreationFailure.InvalidUserId -> TODO()
        UserError.CreationFailure.LastNameInvalidCharacters -> TODO()
        UserError.CreationFailure.LastNameTooLong -> TODO()
    }
